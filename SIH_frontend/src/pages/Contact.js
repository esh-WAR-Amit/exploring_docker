    ...
    <div>
      <section className="text-gray-700 body-font relative">
        <div className="container px-5 py-8 md:py-12 mx-auto">
          <div className="flex flex-col text-center w-full mb-4 md:mb-8">
            <h1 className="sm:text-3xl text-2xl font-bold title-font mb-4 text-primary">
              Contact Us
            </h1>
          </div>
            ...
            <div className="flex flex-wrap -m-2">
              <div className="p-2 w-1/2">
                <div className="relative">
                  <label
                    for="name"
                    className="leading-7 text-sm text-gray-600 ml-1"
                  >
                    Name
                  </label>
                  <input
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <div className="text-indigo-500 cursor-pointer">
                  <a href="mailto:kritrima_tattva@email.com">
                    @kritrima_tattva.com
                  </a>
                </div>
